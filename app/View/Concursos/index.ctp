...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
				<li><?php echo $this->Html->link(__('New Concurso'), array('action' => 'add'), array('class' => '')); ?></li>						<li><?php echo $this->Html->link(__('List Photos'), array('controller' => 'photos', 'action' => 'index'), array('class' => '')); ?></li> 
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $concurso['Concurso']['id']), array('class' => 'btn btn-mini')); ?>
